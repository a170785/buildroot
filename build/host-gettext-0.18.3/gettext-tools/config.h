...
/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module binary-io shall be considered present. */
...
/* Define to 1 if you have the declaration of `feof_unlocked fgets_unlocked',
   and to 0 if you don't. */
#define HAVE_DECL_FEOF_UNLOCKED_FGETS_UNLOCKED 0
...
/* Define to 1 if you have the declaration of `_snprintf _snwprintf', and to 0
   if you don't. */
...
#define INSTALLPREFIX "/home/aav/specter/buildroot-2013.08/output/host/usr"
